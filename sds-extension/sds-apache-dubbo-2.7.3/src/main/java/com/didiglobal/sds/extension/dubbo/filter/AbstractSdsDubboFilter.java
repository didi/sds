 ...
 */
public abstract class AbstractSdsDubboFilter extends ListenableFilter {
    ...
    public AbstractSdsDubboFilter() {
        this.listener = new SdsDubboListenableFilter();
    }
    ...
    class SdsDubboListenableFilter implements Filter.Listener {
