...
public class PointStrategyRequest extends AbstractRequest {
     ...
     * 降级后的返回值，json格式
     */
    private String downgradeReturnValue;
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("PointStrategyRequest{");
        ...
        sb.append(", downgradeReturnValue='").append(downgradeReturnValue).append('\'');
