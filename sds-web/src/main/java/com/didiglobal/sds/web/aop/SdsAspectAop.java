package com.didiglobal.sds.web.aop;

import com.alibaba.fastjson.JSON;
import com.didiglobal.sds.client.log.SdsLoggerFactory;
import com.didiglobal.sds.web.controller.HeartbeatController;
...
public class SdsAspectAop {
    ...
    @Pointcut("execution (public * com.didiglobal.sds.web.controller.*Controller.*(..)) "
